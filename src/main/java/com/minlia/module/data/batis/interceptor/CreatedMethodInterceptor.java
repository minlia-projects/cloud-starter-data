package com.minlia.module.data.batis.interceptor;
...
<!-- 配置AOP -->
<aop:config>
<aop:pointcut id="createdPointCut"
expression="execution(* com.service.impl.BusinessServiceImpl.insert*(..) )" />
<aop:advisor advice-ref="createdMethodInterceptor" pointcut-ref="createdPointCut"/>
</aop:config>
 */
